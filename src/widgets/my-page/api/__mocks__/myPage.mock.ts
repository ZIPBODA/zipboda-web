...
export const MOCK_WISHLIST: WishlistItem[] = [
  { id: "s3", brand: "바움 스튜디오", name: "노르딕 3인 소파", discount: 28, price: 1280000, originalPrice: 1780000, image: "/mock/shop/s3-1.webp" },
  { id: "s6", brand: "폼 스튜디오", name: "메소 액센트 체어", discount: 22, price: 485000, originalPrice: 620000, image: "/mock/shop/s6-1.webp" },
  { id: "s1", brand: "루네 오브제", name: "할로 라운지 체어", discount: 23, price: 398000, originalPrice: 520000, image: "/mock/shop/s1-1.webp" }
];

// figma 135:2096·135:2111·135:2126 주문내역
export const MOCK_ORDERS: Order[] = [
  { id: "s3", brand: "바움 스튜디오", name: "노르딕 3인 소파", orderDate: "2026년 9월 8일 주문", price: 1280000, status: "배송완료", image: "/mock/shop/s3-1.webp" },
  { id: "s6", brand: "폼 스튜디오", name: "메소 액센트 체어", orderDate: "2026년 9월 15일 주문", price: 485000, status: "배송중", image: "/mock/shop/s6-1.webp" },
  { id: "s1", brand: "루네 오브제", name: "할로 라운지 체어", orderDate: "2026년 9월 18일 주문", price: 398000, status: "준비중", image: "/mock/shop/s1-1.webp" }
];
