    ...
    <>
      ...
      <article className="mx-auto w-full bg-surface p-4 md:max-w-3xl md:rounded-3xl md:p-10 md:shadow-sm">
        ...
        <div className="mt-6 flex items-center gap-3 border-y border-line-subtle py-3 md:mt-7 md:justify-start md:gap-5 md:border-0 md:py-0">
          ...
          <button type="button" disabled title={PENDING_TITLE} className={`flex items-center gap-1.5 rounded-lg border border-line-strong px-3 py-2 text-sm text-gray-700 ${PENDING_CLASS}`}>🔖 저장</button>
        ...
        <section className="mt-8 flex flex-col gap-5">
          ...
          <div className="flex items-center gap-2 rounded-xl border border-line bg-surface-secondary p-1 pl-4">
            ...
            <button type="button" disabled title={PENDING_TITLE} className={`shrink-0 rounded-lg bg-brand px-4 py-1.5 text-[13px] font-bold text-brand-on ${PENDING_CLASS}`}>
              등록
            </button>
          </div>
